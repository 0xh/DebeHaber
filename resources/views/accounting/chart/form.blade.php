        ...
        <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator">
            <div class="m-portlet__body">
                ...
                <div v-if="(type === 1 || type === '1') && (sub_type === 5 || sub_type === '5')" class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <router-view name="SearchBox" :selectText="name"   :taxpayer="{{ request()->route('taxPayer')->id }}" :cycle="{{ request()->route('cycle')->id }}" country="{{ request()->route('taxPayer')->country}}"></router-view>
                    </div>
                </div>
