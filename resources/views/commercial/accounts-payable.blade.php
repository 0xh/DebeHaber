            ...
            <div class="m-nav-grid m-nav-grid--skin-light">
                <div class="m-nav-grid__row">
                    <div class="m-nav-grid__item">
                        <img src="/img/icons/account-payable.svg" alt="" width="64">
...
@endphp --}}
<buefy taxpayer="{{ request()->route('taxPayer')->id }}" cycle="{{ request()->route('cycle')->id }}" baseurl="commercial/account_payables" inline-template>

    {{-- <infinity :taxpayer="{{ request()->route('taxPayer')->id}}"
        :cycle="{{ request()->route('cycle')->id }}"
        baseurl="commercial/account_payables"
        inline-template> --}}
        <div>
