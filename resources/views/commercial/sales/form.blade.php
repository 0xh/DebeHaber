...
:defaultCurrency="{{ Config::get('countries.' . request()->route('taxPayer')->country . '.default-currency') }}"  inline-template>
    <div>
        <div class="row">
            <div class="col-6">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-8">
                        <router-view name="SearchBox" :url="/getLastSale/" :current_company="{{ request()->route('taxPayer')->id }}" :cycle="{{request()->route('cycle')->id }}">
                ...
                <div class="col-6">
                    <div class="form-group m-form__group row">
                        <label for="example-text-input" class="col-4 col-form-label">
                            ...
                            {{ Config::get('countries.' . request()->route('taxPayer')->country . '.default-currency') }}
                        </label>
                        <div class="col-8">
                            <div class="input-group">
