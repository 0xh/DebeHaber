...
<purchases-form :trantype ="2" :taxpayer="{{ request()->route('taxPayer')->id}}" :cycle="{{request()->route('cycle')->id }}" inline-template>
    <div>
        <div class="row">
            <div class="col-6">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-8">
                        <router-view name="SearchBox" :url="/getLastPurchase/"  :cycle="{{request()->route('cycle')->id }}" :current_company="{{ request()->route('taxPayer')->id }}" ></router-view>
                    </div>
                </div>
            </div>
