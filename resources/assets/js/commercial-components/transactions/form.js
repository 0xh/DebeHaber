...
Vue.component('transaction-form',
{
  ...
  methods: {
    ...
    getDocuments: function(data)
    {
      var app = this;
      $.ajax({
        url: '/api/' + this.taxpayer + '/get_documents/' + app.trantype,
        headers: {'X-CSRF-TOKEN': CSRF_TOKEN},
        type: 'get',
        dataType: 'json',
        async: true,
    ...
    getCharts: function(data)
    {
      var app = this;
      $.ajax({
        url: '/api/' + app.$parent.taxpayer + '/' + app.$parent.cycle + '/' +  app.$parent.baseurl + '/get-charts/',
        headers: {'X-CSRF-TOKEN': CSRF_TOKEN},
        type: 'get',
        dataType: 'json',
        async: true,
    ...
    init: function (data)
    {
      ...
      // {
      //   if (app.currencies[i].isoCode === app.$parent.taxpayercurrency)
      //   {
      //     app.currency_id=this.currencies[i].id;
      //   }
      // }
    }
  },
